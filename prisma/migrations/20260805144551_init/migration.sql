-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PACKING', 'READY_FOR_PICKUP', 'COLLECTED', 'CANCELLED');
...
-- CreateTable
CREATE TABLE "BranchTransferCharge" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "BranchTransferCharge_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Order" (
    ...
    "transferCharge" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "BranchTransferCharge_sourceBranchId_targetBranchId_key" ON "BranchTransferCharge"("sourceBranchId", "targetBranchId");
...
-- AddForeignKey
ALTER TABLE "BranchTransferCharge" ADD CONSTRAINT "BranchTransferCharge_sourceBranchId_fkey" FOREIGN KEY ("sourceBranchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BranchTransferCharge" ADD CONSTRAINT "BranchTransferCharge_targetBranchId_fkey" FOREIGN KEY ("targetBranchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
