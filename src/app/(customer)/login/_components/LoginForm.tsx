...
import { login } from "@/app/(customer)/auth/actions"
  ...
  return (
    <form action={action} noValidate className="space-y-4">
      ...
      <p className="text-center text-xs text-gray-500">
        ...
        <Link href="/terms" className="text-[var(--color-brand-600)] hover:underline">Terms</Link>
        {" "}and{" "}
        <Link href="/privacy" className="text-[var(--color-brand-600)] hover:underline">Privacy Policy</Link>.
      </p>
    </form>
  )
}
