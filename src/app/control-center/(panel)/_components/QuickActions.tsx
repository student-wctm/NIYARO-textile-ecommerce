...
const actions = [
  { href: "/control-center/products/new",   icon: "🧵", label: "Add Product",       accent: "brand"  },
  { href: "/control-center/categories/new", icon: "🗂️", label: "Add Category",      accent: "purple" },
  { href: "/control-center/branches/new",   icon: "🏪", label: "Add Branch",        accent: "blue"   },
  { href: "/control-center/inventory",      icon: "📦", label: "Manage Inventory",  accent: "amber"  },
  { href: "/control-center/orders",         icon: "📋", label: "View Orders",       accent: "green"  },
] as const
