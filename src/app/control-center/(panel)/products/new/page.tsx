// Control Center — Add New Product
import type { Metadata } from "next"
import Link from "next/link"
import { getActiveCategoryOptions } from "@/lib/products"
import { NewProductClient } from "@/app/control-center/(panel)/products/_components/NewProductClient"
    ...
    <div className="max-w-2xl">
      ...
      <nav aria-label="Breadcrumb" className="mb-6">
        <ol className="flex items-center gap-2 text-sm text-slate-400">
          <li>
            <Link href="/control-center/products" className="hover:text-slate-600 transition-colors">
              Products
            </Link>
          </li>
      ...
      {categories.length === 0 && (
        <div className="mb-6 rounded-lg bg-amber-50 border border-amber-200 px-4 py-3 text-sm text-amber-800">
          ...
          <Link href="/control-center/categories/new" className="font-medium underline">
