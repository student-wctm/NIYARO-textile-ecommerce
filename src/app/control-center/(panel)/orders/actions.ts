...
// =============================================================================
// Control Center — Order Server Actions — PROTECTED: requires active admin session.
// =============================================================================
...
export async function changeOrderStatus(
  ...
  revalidatePath("/control-center/orders")
  revalidatePath(`/control-center/orders/${orderId}`)
