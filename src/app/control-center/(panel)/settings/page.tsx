    ...
    <div className="max-w-3xl space-y-6 pb-10">
      ...
      <div className="rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 px-5 py-4 text-xs text-slate-400 dark:text-slate-500 space-y-1">
        <p>
          ...
          <a href="/control-center/branches" className="underline hover:text-slate-700 dark:hover:text-slate-300 transition-colors">
            Admin → Branches
          </a>.
        ...
        <p>
          ...
          set individually in{" "}
          <a href="/control-center/inventory" className="underline hover:text-slate-700 dark:hover:text-slate-300 transition-colors">
            Admin → Inventory
          </a>.
