...
// =============================================================================
// Control Center — Branch Server Actions
...
export async function createBranch(
  ...
  revalidatePath("/control-center/branches")
  revalidatePath("/(customer)/branches", "layout")
  redirect("/control-center/branches")
}
...
export async function updateBranch(
  ...
  revalidatePath("/control-center/branches")
  revalidatePath(`/control-center/branches/${id}/edit`)
  revalidatePath("/(customer)/branches", "layout")
  redirect("/control-center/branches")
}
